...
{
    /// <inheritdoc />
    public partial class IdentityDatabaseGeneratedOptionNone : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TekushtaData = table.Column<DateTime>(type: "datetime2", nullable: true),
                    User = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Kilometris", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListData = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Slujiteli", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipZastrahovki", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PListId = table.Column<int>(type: "int", nullable: false),
                    DateTrans = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transaks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Transaks_Kilometris_KmId",
                        column: x => x.KmId,
                        principalTable: "Kilometris",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transaks_Lists_PListId",
                        column: x => x.PListId,
                        principalTable: "Lists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transaks_Motos_MotoId",
                        column: x => x.MotoId,
                        principalTable: "Motos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transaks_Otdels_OtdelId",
                        column: x => x.OtdelId,
                        principalTable: "Otdels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transaks_Slujiteli_SlujitelId",
                        column: x => x.SlujitelId,
                        principalTable: "Slujiteli",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipZastrahovkaId = table.Column<int>(type: "int", nullable: false),
                    TekushtaData = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserList = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Zastrahovki", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Zastrahovki_Motos_MotoId",
                        column: x => x.MotoId,
                        principalTable: "Motos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaks_KmId",
                table: "Transaks",
                column: "KmId");

            migrationBuilder.CreateIndex(
                name: "IX_Transaks_MotoId",
                table: "Transaks",
                column: "MotoId");

            migrationBuilder.CreateIndex(
                name: "IX_Transaks_OtdelId",
                table: "Transaks",
                column: "OtdelId");

            migrationBuilder.CreateIndex(
                name: "IX_Transaks_PListId",
                table: "Transaks",
                column: "PListId");

            migrationBuilder.CreateIndex(
                name: "IX_Transaks_SlujitelId",
                table: "Transaks",
                column: "SlujitelId");

            migrationBuilder.CreateIndex(
                name: "IX_Zastrahovki_MotoId",
                table: "Zastrahovki",
                column: "MotoId");
